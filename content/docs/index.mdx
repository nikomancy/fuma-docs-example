...
The following call to the `/vobjects/address__c` endpoint will create Vault objects for each of the addresses in the address.csv** **file.
...
This guide covered the basics of employee onboarding, but the Vault API offers many more capabilities. For complete details about available endpoints, parameters, and response formats, check out our [API Reference for employee onboarding](/onboard-employee) or explore these related topics:

Need help? Join our [Developer Community](https://developer.veevavault.com/community) or contact [Vault Support](https://support.veevavault.com).
